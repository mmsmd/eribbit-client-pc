<template>
  <div class="cart-sku" ref="target">
    ...
    <div class="layer" v-if="visible">
      ...
      <GoodsSku @change="changeSku" v-else :goods="goods" :skuId="skuId"></GoodsSku>
      <XtxButton @click="submit" v-if="!loading" type="primary" size="mini" style="margin-left:60px"
        >确认</XtxButton
      >
    </div>
  </div>
